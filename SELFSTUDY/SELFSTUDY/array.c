...
int main_array(void)
{
	...
	//printf("지하철 1호차에 %d명이 타고 있음\n", subway_1);
	//printf("지하철 2호차에 %d명이 타고 있음\n", subway_2);
	//printf("지하철 3호차에 %d명이 타고 있음\n", subway_3);
